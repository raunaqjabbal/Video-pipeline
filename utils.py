...
#             if i==len(indexes)-1:
#                 scipy.io.wavfile.write(str(count)+".mp3", rate=model.generation_config.sample_rate, data=partaudio)
...
def merge_audio_video(audiopath="intermediate",videopath="inputs", type = "delay"):
